...
# ============ INTELLIGENT MATCHING (NO AI NEEDED) ============
...
def match_providers(shift_id: int, db: Session = Depends(get_db)):
    ...
    for provider in providers:
        ...
        if provider.experience_years >= 10:
            ...
            exp_text = "solid"
        elif provider.experience_years >= 2:
        ...
        # Build explanation
        reason = f"{quality} match: {provider.name} brings {exp_text} {provider.experience_years}+ years of experience as {provider.role}. "
